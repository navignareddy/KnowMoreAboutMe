        ...
        >
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold">Relevant Coursework</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-xl font-bold mb-4">Spring 2023</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={index} className="flex justify-between items-center p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="text-sm text-primary font-medium">{course.grade}</span>
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Fall 2023</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Spring 2024</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Fall 2024</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Spring 2025</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Summer 2025</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
              ...
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6"
              >
                <h3 className="text-xl font-bold mb-4">Fall 2025</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={index} className={`flex justify-between items-center p-3 bg-muted/30 rounded-lg ${course.grade === "NR" ? "opacity-60" : ""}`}>
                      <div>
                        <span className="font-semibold text-foreground">{course.code}</span>
                        <span className="text-muted-foreground ml-2">{course.name}</span>
                      </div>
